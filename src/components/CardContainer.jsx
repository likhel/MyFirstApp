...
const fetchPets = async () => {
  const response = await axios.get('http://127.0.0.1:8000/Pets/petsList/');
  ...
  return (
    <>
      ...
      <div className="bg-white p-6 shadow-md rounded-md mx-auto max-w-4xl mt-8">
        <div className="flex flex-wrap space-y-4 sm:space-y-0 sm:space-x-4">
          ...
          <div className="w-full sm:w-1/3">
            <label htmlFor="breed" className="block text-gray-700 font-bold mb-2">Select animal type</label>
      ...
      <div className="container mx-auto my-8">
        <h2 className="text-2xl font-bold text-gray-800 mb-4 text-center">Available Dogs for Adoption</h2>
